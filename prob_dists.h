double pc_rand_bi(int i,double *ratio_left,double *ratio_right,double *mean_left,double *mean_right,double *stdev_left, double *stdev_right,gsl_rng *rr)
{
